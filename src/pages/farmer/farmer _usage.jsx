...
//           <p className="text-sm text-gray-600">Quick season overview of products used.</p>
//         </div>
...
//       {/* Main Content: Overview or Manage */}
//       {view === "overview" ? (
//         <div className="bg-white rounded-xl shadow p-4">
...
//   // For seed: set product_name from crop to satisfy backend required field
