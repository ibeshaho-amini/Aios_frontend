        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-6 py-6">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-semibold text-white">SupplierPro</h1>
          ...
          <div className="flex-1 px-4 overflow-y-auto">
            <nav className="space-y-1">
              ...
              <SidebarItem name="Orders" icon={<FiShoppingCart />} path="/supplier/orders" />
              <SidebarItem name="Analytics" icon={<FiBarChart2 />} path="/supplier/analytics" />
              <SidebarItem name="Feedback" icon={<FiMessageCircle />} path="/supplier/feedback" />
            </nav>

            <div className="mt-8 pt-6 border-t border-white/20">
              <nav className="space-y-1">
                <SidebarItem name="Profile" icon={<FiSettings />} path="/supplier-dashboard/profile" />
                <SidebarItem name="Help & Support" icon={<FiHelpCircle />} path="/supplier/support" />
              </nav>
            </div>
          </div>
        </div>
